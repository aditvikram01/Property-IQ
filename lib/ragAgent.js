...
WRITE: findings in short, friendly, human sentences (no section/Act/case names in the text). List real 'exceptions' (escape hatches) from the context. Build 'actionPlan' as concrete next steps from the registration process + document checklist (say which office/authority to approach). Put learn-more/official links in 'sources'. Order findings most-severe first. This is general information, not legal advice.`;
