...
// server/index.js. Uses the shared server-side OpenAI key (see lib/llm.js), so
// users no longer have to supply their own key. Prompt building + grounding live
// in src/lib/understand.js (pure, no browser deps) and are reused here verbatim.

import {
  UNDERSTAND_SYSTEM, scriptFor, groundingForText,
  buildExplainPrompt, buildRiskPrompt,
